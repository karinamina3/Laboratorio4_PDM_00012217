package com.kmina.labo4.activities
...
import com.kmina.labo4.R
import com.kmina.labo4.adapters.MovieAdapter
import com.kmina.labo4.network.NetworkUtils
import com.kmina.labo4.pojos.Movie
    ...
    private inner class FetchMovie : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(movieInfo: String) {
            ...
            if (!movieInfo.isEmpty()) {
                ...
                Snackbar.make(main_ll, "Movieinfo vacia", Snackbar.LENGTH_SHORT).show()
            }
        }
    }
